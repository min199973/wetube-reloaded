var createFFmpegCore = function () {
  ...
  return function (createFFmpegCore) {
    ...
    if (l) {
    ...
    } else if (pa) "undefined" != typeof read && (ta = function (a) {
      return read(a);
    }), va = function (a) {
      ...
      return a;
    }, "undefined" != typeof scriptArgs ? ja = scriptArgs : "undefined" != typeof arguments && (ja = arguments), "function" === typeof quit && (la = function (a) {
      quit(a);
    }), "undefined" !== typeof print && ("undefined" === typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" !== typeof printErr ? printErr : print);else if (ma || oa) oa ? ra = self.location.href : "undefined" !== typeof document && document.currentScript && (ra = document.currentScript.src), _scriptDir && (ra = _scriptDir), 0 !== ra.indexOf("blob:") ? ra = ra.substr(0, ra.lastIndexOf("/") + 1) : ra = "", l ? (ta = function (a, b) {
      wa || (wa = require("fs"));
      xa || (xa = require("path"));
      a = xa.normalize(a);
      return wa.readFileSync(a, b ? null : "utf8");
    ...
    if (n) Ca = f.wasmMemory, qa = f.buffer;else if (f.wasmMemory) Ca = f.wasmMemory;else if (Ca = new WebAssembly.Memory({
      initial: Va / 65536,
      maximum: Va / 65536,
      shared: !0
    ...
    function vb(a, b) {
      ...
      var c = Atomics.load(D, L.Vf >> 2),
        d = 0;
      if (c == a && Atomics.compareExchange(D, L.Vf >> 2, c, 0) == c && (--b, d = 1, 0 >= b)) return 1;
    ...
    function wb(a) {
      if (n) throw "Internal Error! cancelThread() can only ever be called from main application thread!";
    ...
    function xb(a) {
      if (n) throw "Internal Error! cleanupThread() can only ever be called from main application thread!";
    ...
    var L = {
      ...
      Qi: function (a) {
        var b = rb | 0;
        b && (Atomics.store(E, b + 4 >> 2, a), Atomics.store(E, b + 0 >> 2, 1), Atomics.store(E, b + 60 >> 2, 1), Atomics.store(E, b + 64 >> 2, 0), L.eh(), vb(b + 0, 2147483647), ub(0, 0, 0), threadInfoStruct = 0, n && postMessage({
          cmd: "exit"
        }));
      },
      Pi: function () {
      ...
      Oi: function () {
        ...
        L.Gf = [];
        for (a = 0; a < L.Kf.length; ++a) c = L.Kf[a], b = c.yf, L.Pg(b), c.terminate();
        L.Kf = [];
      },
      Pg: function (a) {
        if (a) {
      ...
      vi: function (a, b) {
        a.onmessage = function (c) {
          ...
          if (d.targetThread && d.targetThread != (rb | 0)) {
            ...
            c = d.thread;
            if (n) throw "Internal Error! killThread() can only ever be called from main application thread!";
            ...
            c.worker.yf = void 0;
          } else if ("cancelThread" === e) wb(d.thread);else if ("loaded" === e) a.loaded = !0, b && b(a), a.og && (a.og(), delete a.og);else if ("print" === e) ea("Thread " + d.threadId + ": " + d.text);else if ("printErr" === e) h("Thread " + d.threadId + ": " + d.text);else if ("alert" === e) alert("Thread " + d.threadId + ": " + d.text);else if ("exit" === e) a.yf && Atomics.load(E, a.yf.Lh + 68 >> 2) && L.Ag(a);else if ("exitProcess" === e) {
            noExitRuntime = !1;
            try {
              da(d.returnCode);
            } catch (k) {
          ...
          } else "cancelDone" === e ? L.Ag(a) : "objectTransfer" !== e && ("setimmediate" === c.data.target ? a.postMessage(c.data) : h("worker sent an unknown command " + e));
          L.Mg = void 0;
        };
    ...
    function Wb(a, b) {
      ...
      a = c(a.split("/"));
      b = c(b.split("/"));
      for (var d = Math.min(a.length, b.length), e = d, g = 0; g < d; g++) if (a[g] !== b[g]) {
        e = g;
        break;
      }
      d = [];
      ...
      O = {
        ...
        Ji: function (a, b) {
          if (a.gf != b) if (0 == b) a.bf = null, a.gf = 0;else {
            ...
            } else if (a.bf || (a.bf = []), a.bf.length > b) a.bf.length = b;else for (; a.bf.length < b;) a.bf.push(0);
            a.gf = b;
          }
        },
        cf: {
        ...
        df: {
          read: function (a, b, c, d, e) {
            ...
            if (8 < a && g.subarray) b.set(g.subarray(e, e + a), c);else for (d = 0; d < a; d++) b[c + d] = g[e + d];
            return a;
          },
          write: function (a, b, c, d, e, g) {
            ...
            O.sh(a, e + d);
            if (a.bf.subarray && b.subarray) a.bf.set(b.subarray(c, c + d), e);else for (g = 0; g < d; g++) a.bf[e + g] = b[c + g];
      ...
      N = {
        ...
        ff: function (a, b) {
          ...
          for (d = 0; d < a.length; d++) {
            ...
            if (!g || b.wf) for (g = 0; N.Mf(e.mode);) if (e = N.readlink(c), c = Vb(Rb(c), e), e = N.ff(c, {
              ah: b.ah
        ...
        bj: function (a, b, c, d, e) {
          ...
          r.read = function (q, t, w, B, p) {
            ...
            if (q.slice) for (var x = 0; x < B; x++) t[w + x] = q[p + x];else for (x = 0; x < B; x++) t[w + x] = q.get(p + x);
            return B;
          };
          m.df = r;
          return m;
    ...
    function Fc(a) {
      ...
      for (b = c = 0; b < a.length; b++) if ("string" === typeof a[b]) {
        if ("Z" === a[b]) {
    ...
    function Nc(a) {
      ...
      for (c = 0; 8 > c; c++) 1 < d && 0 === a[c] && c >= g && c < g + d ? c === g && (b += ":", 0 === g && (b += ":")) : (b += Number(Oc(a[c] & 65535)).toString(16), b += 7 > c ? ":" : "");
      return b;
    }
    function Pc(a, b) {
      var c = Sa[a >> 1],
      ...
      try {
        ...
        switch (a) {
          ...
          case 16:
            ...
            for (var Qa = 0, W = 0; W < na; W++) Qa += D[ha + (8 * W + 4) >> 2];
          ...
          case 17:
            ...
            for (W = 0; 0 < dc && W < na; W++) if (bc = D[ha + 8 * W >> 2], cc = D[ha + (8 * W + 4) >> 2]) B = Math.min(cc, dc), x = I.buffer.subarray(k, k + B), Ka.set(x, bc + k), k += B, dc -= B;
            return k;
          default:
            return -52;
        }
    ...
    function ud(a, b, c) {
      if (b) {
        ...
        if (void 0 === d) switch (e = U.getParameter(a), typeof e) {
          case "number":
            d = e;
            break;
          case "boolean":
    ...
    var zd = [],
      Ad = [];
    function M(a, b) {
      for (var c = arguments.length - 2, d = y(), e = Ha(8 * c), g = e >> 3, k = 0; k < c; k++) Ua[g + k] = arguments[2 + k];
      c = Bd(a, c, e, b);
      C(d);
      return c;
    }
    ...
    function Db(a) {
      if (n) throw "Internal Error! spawnThread() can only ever be called from main application thread!";
      var b = L.li();
    ...
    function Yd(a, b) {
      ...
      if (n && selfThreadId == a) return h("PThread " + a + " is attempting to join to itself!"), 16;
      if (!n && L.xf == a) return h("Main thread " + a + " is attempting to join to itself!"), 16;
      ...
      for (Vc();;) {
        ...
        if (1 == c) return c = Atomics.load(E, a + 4 >> 2), b && (D[b >> 2] = c), Atomics.store(E, a + 68 >> 2, 1), n ? postMessage({
          cmd: "cleanupThread",
          thread: a
        }) : xb(a), 0;
        if (n && threadInfoStruct && !Atomics.load(E, threadInfoStruct + 60 >> 2) && 2 == Atomics.load(E, threadInfoStruct + 0 >> 2)) throw "Canceled!";
        n || Cb();
        Wc(a, c, n ? 100 : 1);
      }
    }
    ...
    var Ge = {
      ...
      F: function (a, b, c) {
        Dd.length = 0;
        var d;
        for (c >>= 2; d = Ka[b++];) (d = 105 > d) && c & 1 && c++, Dd.push(d ? Ua[c++ >> 1] : D[c]), ++c;
            ...
            if (d) {
              if (35716 == b) a = U.getProgramInfoLog(R[a]), null === a && (a = "(unknown error)"), D[c >> 2] = a.length + 1;else if (35719 == b) D[c >> 2] = d.Xg;else if (35722 == b) {
                if (-1 == d.jg) {
                  ...
                  for (b = d.jg = 0; b < e; ++b) d.jg = Math.max(d.jg, U.getActiveAttrib(a, b).name.length + 1);
                }
                D[c >> 2] = d.jg;
              } else if (35381 == b) {
                if (-1 == d.kg) for (a = R[a], e = U.getProgramParameter(a, 35382), b = d.kg = 0; b < e; ++b) d.kg = Math.max(d.kg, U.getActiveUniformBlockName(a, b).length + 1);
                D[c >> 2] = d.kg;
      ...
      oc: function (a, b, c, d) {
        if (a = U.getShaderSource(ed[a])) b = 0 < b && d ? Ia(a, d, b) : 0, c && (D[c >> 2] = b);
      },
      rc: function (a, b, c) {
        c ? 35716 == b ? (a = U.getShaderInfoLog(ed[a]), null === a && (a = "(unknown error)"), D[c >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = U.getShaderSource(ed[a]), D[c >> 2] = a ? a.length + 1 : 0) : D[c >> 2] = U.getShaderParameter(ed[a], b) : T(1281);
      },
      nc: function (a) {
        if (id[a]) return id[a];
        switch (a) {
      ...
      Xb: function (a) {
        ...
        for (var c = a.Nh, d = U.getProgramParameter(b, 35718), e = 0; e < d; ++e) {
          ...
          if (m) {
            ...
            c[k] = [g.size, r];
            S[r] = m;
            for (var q = 1; q < g.size; ++q) m = U.getUniformLocation(b, k + "[" + q + "]"), r = ld(S), S[r] = m;
          }
        }
      },
      Wb: function (a, b) {
      ...
      Ab: function (a, b, c) {
        if (288 >= b) for (var d = zd[b - 1], e = 0; e < b; ++e) d[e] = F[c + 4 * e >> 2];else d = F.subarray(c >> 2, c + 4 * b >> 2);
        U.uniform1fv(S[a], d);
      },
      zb: function (a, b) {
        U.uniform1i(S[a], b);
      ...
      yb: function (a, b, c) {
        if (288 >= b) for (var d = Ad[b - 1], e = 0; e < b; ++e) d[e] = D[c + 4 * e >> 2];else d = D.subarray(c >> 2, c + 4 * b >> 2);
        U.uniform1iv(S[a], d);
      },
      xb: function (a, b, c) {
        U.uniform2f(S[a], b, c);
      ...
      wb: function (a, b, c) {
        if (144 >= b) for (var d = zd[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = F[c + 4 * e >> 2], d[e + 1] = F[c + (4 * e + 4) >> 2];else d = F.subarray(c >> 2, c + 8 * b >> 2);
        U.uniform2fv(S[a], d);
      },
      vb: function (a, b, c) {
        U.uniform2i(S[a], b, c);
      ...
      ub: function (a, b, c) {
        if (144 >= b) for (var d = Ad[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = D[c + 4 * e >> 2], d[e + 1] = D[c + (4 * e + 4) >> 2];else d = D.subarray(c >> 2, c + 8 * b >> 2);
        U.uniform2iv(S[a], d);
      },
      tb: function (a, b, c, d) {
      ...
      sb: function (a, b, c) {
        if (96 >= b) for (var d = zd[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = F[c + 4 * e >> 2], d[e + 1] = F[c + (4 * e + 4) >> 2], d[e + 2] = F[c + (4 * e + 8) >> 2];else d = F.subarray(c >> 2, c + 12 * b >> 2);
        U.uniform3fv(S[a], d);
      },
      rb: function (a, b, c, d) {
      ...
      qb: function (a, b, c) {
        if (96 >= b) for (var d = Ad[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = D[c + 4 * e >> 2], d[e + 1] = D[c + (4 * e + 4) >> 2], d[e + 2] = D[c + (4 * e + 8) >> 2];else d = D.subarray(c >> 2, c + 12 * b >> 2);
        U.uniform3iv(S[a], d);
      },
      ...
      mb: function (a, b, c) {
        if (72 >= b) for (var d = Ad[4 * b - 1], e = 0; e < 4 * b; e += 4) d[e] = D[c + 4 * e >> 2], d[e + 1] = D[c + (4 * e + 4) >> 2], d[e + 2] = D[c + (4 * e + 8) >> 2], d[e + 3] = D[c + (4 * e + 12) >> 2];else d = D.subarray(c >> 2, c + 16 * b >> 2);
        U.uniform4iv(S[a], d);
      },
      lb: function (a, b, c, d) {
        if (72 >= b) for (var e = zd[4 * b - 1], g = 0; g < 4 * b; g += 4) e[g] = F[d + 4 * g >> 2], e[g + 1] = F[d + (4 * g + 4) >> 2], e[g + 2] = F[d + (4 * g + 8) >> 2], e[g + 3] = F[d + (4 * g + 12) >> 2];else e = F.subarray(d >> 2, d + 16 * b >> 2);
        U.uniformMatrix2fv(S[a], !!c, e);
      },
      kb: function (a, b, c, d) {
        if (32 >= b) for (var e = zd[9 * b - 1], g = 0; g < 9 * b; g += 9) e[g] = F[d + 4 * g >> 2], e[g + 1] = F[d + (4 * g + 4) >> 2], e[g + 2] = F[d + (4 * g + 8) >> 2], e[g + 3] = F[d + (4 * g + 12) >> 2], e[g + 4] = F[d + (4 * g + 16) >> 2], e[g + 5] = F[d + (4 * g + 20) >> 2], e[g + 6] = F[d + (4 * g + 24) >> 2], e[g + 7] = F[d + (4 * g + 28) >> 2], e[g + 8] = F[d + (4 * g + 32) >> 2];else e = F.subarray(d >> 2, d + 36 * b >> 2);
      ...
      Ra: function (a) {
        if (a === L.Ph) return h("Main thread (id=" + a + ") cannot be canceled!"), 71;
    ...
    function Me(a) {
      function b() {
        if (!Ke && (Ke = !0, f.calledRun = !0, !Ea)) {
          ...
          if (!n) {
            if (f.postRun) for ("function" == typeof f.postRun && (f.postRun = [f.postRun]); f.postRun.length;) c = f.postRun.shift(), ab.unshift(c);
            pb(ab);
          }
        }
      }
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = createFFmpegCore;else if (typeof define === 'function' && define['amd']) define([], function () {
